"""
Django settings for raspy_glade_dev_98705 project.
...
ROOT_URLCONF = 'raspy_glade_dev_98705.urls'
...
WSGI_APPLICATION = 'raspy_glade_dev_98705.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_glade_dev_98705 API",
    "DESCRIPTION": "API documentation for raspy_glade_dev_98705 App",
    "VERSION": "v1",
}
